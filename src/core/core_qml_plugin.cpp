...
public:
    void registerTypes(const char* uri) override {
        ...
        qmlRegisterUncreatableType<QMapLibre::Map>(uri, 3, 0, "Map", "Create via JavaScript only");
        qmlRegisterUncreatableType<QMapLibre::MetalRendererBackend>(
            uri, 3, 0, "MetalRendererBackend", "Create via JavaScript only");
    }
};
